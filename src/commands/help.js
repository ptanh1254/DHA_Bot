function buildHelpMessage(prefix = "!") {
    return [
        ...
        "- C\u00e1c l\u1ec7nh c\u1ea7n tag: `checktt`, `thongtin`, `kick`, `mute`, `unmute`.",
        "",
        "==============================",
        "1) NH\u00d3M CH\u00c0O M\u1eeaNG",
        "==============================",
        ...
        `- \`${prefix}autokick\``,
        "  Xem trang thai auto kick nguoi tung bi kick.",
        `- \`${prefix}autokick on/off\``,
        "  Bat/tat tu dong kick khi nguoi tung bi kick vao lai nhom.",
        "",
        "==============================",
        ...
        `- \`${prefix}camnoibay\``,
        "  Xem trang thai auto mute theo danh sach tu cam.",
        `- \`${prefix}camnoibay on\``,
        "  Bat auto mute: dung tu cam la bot xoa tin + khoa mom tu dong.",
        `- \`${prefix}camnoibay off\``,
        "  Tat auto mute theo tu cam.",
        "  Danh sach tu cam sua trong file `src/config/bannedWords.txt` (moi dong 1 tu/cum tu).",
        "",
        "==============================",
        "4) NHOM KEY DUNG BOT",
        "==============================",
        `- \`${prefix}setkey <ma-key>\``,
        "  (Admin) Tao/doi key va bat che do key cho nhom.",
        `- \`${prefix}setkey on/off\``,
        "  (Admin) Bat/tat che do key.",
        `- \`${prefix}key <ma-key>\``,
        "  Thanh vien nhap key de duoc dung lenh bot.",
        `- \`${prefix}addadmin @TenNguoiDung\``,
        "  (Admin) Them nhanh nguoi duoc tag vao danh sach duoc dung bot.",
        "",
        "==============================",
