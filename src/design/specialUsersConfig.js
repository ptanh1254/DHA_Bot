        ...
        themes: {
            userCard: {
                background: {
                    gradient: [
                        { stop: 0, color: "#1a1a2e" },
                        { stop: 0.5, color: "#7dcdff" },
                        { stop: 1, color: "#c97dff" },
                    ],
                    glow: [
                        { x: 0.2, y: 0.2, radius: 450, color: "rgba(125, 205, 255, 0.3)" },
                        { x: 0.8, y: 0.8, radius: 450, color: "rgba(201, 125, 255, 0.3)" },
                    ],
                    dots: {
                ...
                card: {
                    ...
                    stroke: "rgba(125, 205, 255, 0.6)",
                    strokeGradient: {
                        from: { x: 0, y: 0 },
                        to: { x: 1, y: 0 },
                        colors: ["#7dcdff", "#c97dff"],
                    },
                    lineWidth: 2,
                    shadow: "rgba(125, 205, 255, 0.4)",
                    shadowBlur: 30,
                    shadowOffsetY: 10,
                },
                title: {
                    titleColor: "#ffffff",
                    subColor: "rgba(220, 240, 255, 0.9)",
                },
                name: {
                    color: "#ffffff",
                },
                ...
                rows: {
                    ...
                    stroke: "rgba(125, 205, 255, 0.3)",
                    labelColor: "rgba(220, 240, 255, 0.9)",
                    valueColor: "#ffffff",
                },
                footer: {
                ...
                rainbow: true,
                colors: ["#7dcdff", "#c97dff", "#a8e6ff", "#c97dff", "#7dcdff"],
            },
            checktt: {
                background: {
                    top: "#7dcdff",
                    bottom: "#c97dff",
                    glow: "rgba(125, 205, 255, 0.3)",
                },
                panel: {
                ...
                title: "#ffffff",
                displayName: "#ffffff",
                uid: "rgba(220, 240, 255, 0.9)",
                rowLabel: "rgba(220, 240, 255, 0.9)",
                rowValue: "#ffffff",
                rowFill: "rgba(255, 255, 255, 0.1)",
                rowStroke: "rgba(125, 205, 255, 0.4)",
                noteFill: "rgba(255, 255, 255, 0.08)",
                noteStroke: "rgba(125, 205, 255, 0.5)",
                rainbow: true,
                colors: ["#7dcdff", "#c97dff", "#a8e6ff", "#c97dff", "#7dcdff"],
            },
            check: {
